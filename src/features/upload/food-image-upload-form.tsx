...
export function FoodImageUploadForm() {
  ...
  return (
    <>
      ...
      <div
        className={[
          "hidden gap-4 lg:grid lg:grid-cols-[minmax(0,1fr)_420px]",
      ...
      >
        <div
          ...
          className={[
            "flex min-h-72 flex-col items-center justify-center rounded-lg border border-dashed p-6 text-center transition",
            isDragging
              ? "border-primary bg-primary-soft"
              : "border-slate-300 bg-surface-muted",
          ].join(" ")}
        >
          <div className="flex size-11 items-center justify-center rounded-md bg-white text-primary shadow-sm">
          ...
          <p className="mt-2 max-w-sm text-sm leading-6 text-slate-600">
            Use the camera, choose a file, or drag an image here. Clear,
            well-lit photos produce better estimates.
          </p>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <button
              ...
              className="inline-flex h-10 items-center rounded-md bg-primary px-4 text-sm font-semibold text-white hover:bg-primary-hover"
            >
            ...
            <button
              ...
              className="h-10 rounded-md border border-slate-300 bg-white px-4 text-sm font-semibold text-slate-800 hover:bg-slate-100"
            >
              Choose image
            </button>
          </div>
      ...
      <aside className="rounded-lg border border-border-subtle bg-surface p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-base font-semibold text-slate-950">Preview</h2>
          <span className="text-xs font-medium text-muted-foreground">Before analysis</span>
        </div>
        <div className="mt-3 overflow-hidden rounded-lg border border-border-subtle bg-surface-muted">
          {previewUrl ? (
            <Image
              src={previewUrl}
              alt="Selected food"
